...
\begin{enumerate}
\item Load the CES .csv file from \href{https://raw.githubusercontent.com/ASDS-TCD/DataViz_2026/refs/heads/main/datasets/NCSS_v1.csv}{GitHub} into your global environment. Filter respondents to only include "high quality" participants: 
\begin{verbatim}
ces2015 <- ces2015 |> filter(discard == 0)
\end{verbatim}
\item Recode potential turnout as a binary variable using \texttt{voted\_for}. Consider respondents who gave a valid party as having voted, while “none/spoiled ballot” as not having voted. Treat “Don’t know” (98) and “Refused” (99) as missing.
...
\begin{enumerate}
	...
	\item Produce bar charts of turnout by income (\texttt{income\_full}), faceted by province.
